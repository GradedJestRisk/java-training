...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("SELECT * FROM birds");
        getAllBirds(conn);
        System.out.println("------------");

        System.out.println("SELECT * FROM birds WHERE bird=eagle");
        getFilteredBirds(conn);
        System.out.println("------------");

        try {
            System.out.println("INSERT INTO birds(bird) VALUES('rooster')");
            insertBird(conn);
        ...
        System.out.println("UPDATE birds SET description = 'has a red crown' WHERE bird='rooster'");
        updateBird(conn);
        System.out.println("------------");
        ...
        System.out.println("DELETE FROM birds WHERE bird='rooster'");
        deleteBird(conn);
        System.out.println("------------");
    ...
    private static DataSource createDataSource() {
        final String url =
                "jdbc:postgresql://localhost:5497/integration_db?user=integration&password=integration";
